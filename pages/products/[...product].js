...
export default function CreateProduct() {
  ...
  const productTypes = [
    ...
    {
      label: "3D simple product",
      value: "3dsimple",
    },
    {
      label: "3D variable product",
      value: "3dvariable",
    },
  ];
  ...
  useEffect(() => {
    ...
    if (productType === "variable" || productType === "3dvariable") {
      if (product?.variantsOptions?.length > 0) {
  ...
  const renderThumbnails = () => (
    <div className={classes.formFields}>
      <div className={classes.formField}>
        ...
        <Field name={"thumbnails"} validate={isRequired}>
          {(props) => (
            <DropzoneMultiple
              {...props.input}
              imageFormats={"image/*"}
  ...
  const submit = (values) => {
    ...
    if (values.productType === "simple" || values.productType === "3dsimple") {
      let valuesObject;
      ...
      >
        {({ handleSubmit, invalid }) => (
          <form noValidate onSubmit={handleSubmit}>
            ...
            {productType === "simple" || productType === "3dsimple" ? (
              <>
                {/* Rendering simple product & 3d simple product */}
                {productType === "3dsimple" && renderThumbnails()}
                {renderFields(
                  productType === "simple"
                    ? "simpleProduct"
                    : "3dSimpleProduct",
              ...
              <>
                {/* Rendering variable product & 3d variable product */}
                {productType === "3dvariable" && renderThumbnails()}
                {/* Product variants */}
                {(productType === "variable" ||
                  productType === "3dvariable") && (
                  <FieldArray
                            ...
                            {index === 0 && (
                              <div className={classes.incDecBtn}>
                                ...
                                {(product?.productType === "variable" ||
                                  product?.productType === "3dvariable") &&
                                productId ? (
