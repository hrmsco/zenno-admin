      ...
      renderCell: (params) => {
        return (
          <div className={classes.product}>
            {GetProductDetails(params.row).productType === "simple" ||
            GetProductDetails(params.row).productType === "variable" ? (
              <CustomImage
                src={
              ...
              <>
                {GetProductDetails(params.row).images[0].endsWith(".gltf") ||
                GetProductDetails(params.row).images[0].endsWith(".glb") ? (
                  <CustomImage
                    src={
                      process.env.NEXT_PUBLIC_BACKEND_URL +
                      "product/" +
